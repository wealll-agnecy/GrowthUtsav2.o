...
const VerifyTicket = () => {
    ...
    if (loading) {
        return (
            <div className="vh-100 vw-100 d-flex flex-column align-items-center justify-content-center bg-black">
                ...
                <div className="mt-4 text-white fw-black tracking-widest uppercase opacity-40 small">Syncing Clearance Node...</div>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="vh-100 vw-100 d-flex align-items-center justify-content-center bg-black p-4">
                <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="w-100 max-w-500">
                    <div className="glass-card border-danger/20 text-center p-5 rounded-5 shadow-2xl">
                        <FaTimesCircle size={80} className="text-danger mb-4 shadow-glow mx-auto" />
                        <h1 className="text-white fw-black display-6 tracking-tightest mb-3 uppercase">INVALID</h1>
                        <p className="text-white-50 fs-5 mb-0 font-bold">{error}</p>
                    </div>
                </motion.div>
            </div>
        );
    ...
    return (
        <div className="vh-100 vw-100 bg-black overflow-hidden d-flex align-items-center justify-content-center p-3 p-md-0">
            <AnimatePresence mode="wait">
                ...
                >
                    <div className="glass-card border-white/10 rounded-5 overflow-hidden shadow-2xl">
                        ...
                        <div className="p-4 p-md-5 bg-dark">
                            ...
                            <div className="text-center mb-5">
                                <span className="text-primary-light small fw-black uppercase tracking-widest mb-1 d-block opacity-60">Credential Holder</span>
                                <h1 className="text-white fw-black display-4 m-0 tracking-tightest text-uppercase">{ticket.name}</h1>
                            </div>

                            <Row className="g-3 mb-4">
                                <Col xs={12}>
                                    <div className="p-4 bg-white/5 rounded-4 border border-white/5 shadow-inner">
                                        <span className="text-white-50 small fw-black uppercase tracking-widest mb-2 d-block opacity-50">Event Node</span>
                                        <div className="text-white fw-black h4 m-0 d-flex align-items-center gap-3">
                            ...
                            {/* Contact & Seat Info */}
                            <div className="p-4 glass-panel rounded-4 border-white/5 mb-5 shadow-inner">
                                <Row className="align-items-center g-3">
                                    <Col xs={12}>
                                        <div className="d-flex align-items-center gap-3">
                                            <FaEnvelope className="text-primary-light" />
                                            <span className="text-white-50 small font-bold">{ticket.email}</span>
                                        </div>
                                    </Col>
                                    <Col xs={12}>
                                        <div className="d-flex align-items-center gap-3">
                                            <FaPhoneAlt className="text-success-light" />
                                            <span className="text-white-50 small font-bold">{ticket.phone}</span>
                                        </div>
                                    </Col>
                                    <Col xs={12} className="border-top border-white/5 pt-2 mt-3">
                                        <div className="d-flex align-items-center gap-3">
                                            <FaChair className="text-warning-light" />
                                            <span className="text-white-50 small font-bold text-uppercase tracking-widest">{ticket.seat} Sector</span>
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                            ...
                            <div className="d-flex justify-content-between align-items-center pt-2">
                                <div>
                                    <span className="text-white-50 small fw-black uppercase tracking-widest d-block opacity-40">Identifier</span>
                                    <span className="text-primary-light fw-black h5 m-0 font-bold tracking-widest">{ticket.ticketCode}</span>
                                </div>
