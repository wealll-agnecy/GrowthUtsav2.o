    ...
    if (error) return (
        <div className="content-wrapper min-vh-100 d-flex align-items-center justify-content-center">
            <Container className="text-center">
                ...
                <Button as={Link} to="/organizer/dashboard" variant="primary" className="rounded-pill px-5 py-3 fw-black mt-4 shadow-lg border-0 glow-hover">REVERT TO CONSOLE</Button>
            </Container>
        </div>
    );
                                        ...
                                        <Col lg={4}>
                                            <div className="glass-panel p-4 rounded-5 border-white/5 shadow-inner mb-4">
                                                ...
                                                <Form onSubmit={handleAddVendor}>
                                                    ...
                                                    <Button type="submit" variant="primary" className="w-100 rounded-pill py-3 fw-black glow-hover text-uppercase border-0 shadow-lg tracking-widest">DEPLOY VENDOR</Button>
                                                </Form>
                                            </div>
                                        </Col>
                                        <Col lg={8}>
                                        ...
                                        <Col lg={4}>
                                            <div className="glass-panel p-4 rounded-5 border-white/5 shadow-inner mb-4">
                                                ...
                                                <Form onSubmit={handleAddEquip}>
                                                    ...
                                                    <Button type="submit" variant="secondary" className="w-100 rounded-pill py-3 fw-black glow-hover text-uppercase border-0 shadow-lg tracking-widest bg-secondary text-white">REGISTER ASSET</Button>
                                                </Form>
                                            </div>
                                        </Col>
                                        <Col lg={8}>
